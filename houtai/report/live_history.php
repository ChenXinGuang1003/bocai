        ...
        <tr>
            <td valign="top">
                ...
                <table width="100%" border="0" cellpadding="5" cellspacing="1" class="font12" style="margin-top:5px;" bgcolor="#798EB9">
                    ...
                    $total_bet_count = $zr_result["bet_count"] + $zc_result["bet_count"] + $zr_result_bbin["bet_count"] + $zc_result_bbin["bet_count"];
                    $total_bet_money = $zr_result["bet_money"] - $zc_result["bet_money"] + $zr_result_bbin["bet_money"] - $zc_result_bbin["bet_money"];


					$sql2 = report_live::getZhenRenCount($s_time,$e_time);
                    ...
                    <tr align="center"  style="background-color:#FFFFFF; line-height:20px;">
                        ...
                        <td align="center" valign="middle"><?=$zr_result["bet_count"]+$zr_result_bbin["bet_count"]?></td>
                        <td align="center" valign="middle"><?=$zr_result["bet_money"]+$zr_result_bbin["bet_money"]?></td>
                        <td align="center" valign="middle"><?=$zc_result["bet_count"]+$zc_result_bbin["bet_count"]?></td>
                        <td align="center" valign="middle"><?=$zc_result["bet_money"]+$zc_result_bbin["bet_money"]?></td>
