...
function update_auto(){
	window.open('/newpt/newRecord.php','list','width=440,height=180,left=50,top=100,scrollbars=no').focus();
}
</script>
</HEAD>
...
<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
  <tr>
    <td height="24" nowrap background="../images/06.gif"><font >&nbsp;<span class="STYLE2">PT真人报表</span></font></td>
  </tr>
  <tr>
