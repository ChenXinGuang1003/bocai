...
<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
  <tr>
    <td height="24" nowrap background="../images/06.gif"><font >&nbsp;<span class="STYLE2">MG真人报表（注单为美东时间）</span></font></td>
  </tr>
  <tr>
...
<?php 
		...
		$sql .= " where platformType = 'MG' and  betTime >= '" . $_GET['date_start'] . "'";
		$sql .= " and betTime <= '" . $_GET['date_end'] . "'";
		if($_GET['username']) $sql .= " and playerName = '$user'";
		$sql .= " GROUP BY playerName ORDER BY cnt DESC) a left join user_list b on a.playerName = b.mg_username ";
		$query = $mysqli->query($sql);
