function saveOdds(){
    ...
    function saveGeneralOdds(){
        $.ajax({
            type: "POST",
            url: "../lottery/oddssetting/TJSF/save/saveGeneralOdds.php",
            data: {
    ...
    function saveSpecialOdds(){
        $.ajax({
            type: "POST",
            url: "../lottery/oddssetting/TJSF/save/saveSpecialOdds.php",
            data: {
    ...
    function saveNumberOdds(){
        $.ajax({
            type: "POST",
            url: "../lottery/oddssetting/TJSF/save/saveNumberOdds.php",
            data: {
    ...
    function saveSeasonsOdds(){
        $.ajax({
            type: "POST",
            url: "../lottery/oddssetting/TJSF/save/saveSeasonsOdds.php",
            data: {
    ...
    function saveZfbOdds(){
        $.ajax({
            type: "POST",
            url: "../lottery/oddssetting/TJSF/save/saveZfbOdds.php",
            data: {
    ...
    function saveTigerOdds(){
        $.ajax({
            type: "POST",
            url: "../lottery/oddssetting/TJSF/save/saveTigerOdds.php",
            data: {
    ...
    function saveChooseOdds(){
        $.ajax({
            type: "POST",
            url: "../lottery/oddssetting/TJSF/save/saveChooseOdds.php",
            data: {
