...
$odds = odds_lottery_normal::getOdds($lottery_name,"牛牛");
...
\'<input type="hidden" name="MyRtype" value="701"/>\'+
...
\'<div id="SendB5">\'+
    ...
    \'</div>\'+
\'</form>\';
document.getElementById("c_rtype").innerHTML = "牛牛";
document.getElementById("sRtype").value = "701";
