...
$odds = odds_lottery_normal::getOdds($lottery_name,"(后三)组选三");
...
document.getElementById("Game").innerHTML = \'<form id="formB5" name="D3_018" action="/member/quickB3_act.php" method="post" onsubmit="return false">\'+
    ...
    \'<input type="hidden" name="MyRtype" value="597"/>\'+
    ...
    \'<div id="SendB5">\'+
        ...
        \'</div>\'+
    \'</form>\';
document.getElementById("c_rtype").innerHTML = "(后三)组选三";
document.getElementById("sRtype").value = "597";
