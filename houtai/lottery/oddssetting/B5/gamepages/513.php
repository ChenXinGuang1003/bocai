...
$odds = odds_lottery_normal::getOdds($lottery_name,"豹子顺子(后三)");
...
\'<input type="hidden" name="MyRtype" value="513"/>\'+
...
\'<div id="SendB5">\'+
    ...
    \'</div>\'+
\'</form>\';
document.getElementById("c_rtype").innerHTML = "豹子顺子(后三)";
document.getElementById("sRtype").value = "513";
if (document.getElementById("memberTop")) {
var h1 = document.getElementById("memberTop").getElementsByTagName("h1")[0];
h1.innerHTML = "豹子顺子(后三)";
}
