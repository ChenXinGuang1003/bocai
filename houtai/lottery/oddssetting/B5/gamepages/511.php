...
$odds = odds_lottery_normal::getOdds($lottery_name,"豹子顺子(前三)");
...
\'<input type="hidden" name="MyRtype" value="511"/>\'+
...
\'<div id="SendB5">\'+
    ...
    \'</div>\'+
\'</form>\';
document.getElementById("c_rtype").innerHTML = "豹子顺子(前三)";
document.getElementById("sRtype").value = "511";
if (document.getElementById("memberTop")) {
var h1 = document.getElementById("memberTop").getElementsByTagName("h1")[0];
h1.innerHTML = "豹子顺子(前三)";
}
