...
$odds = odds_lottery_normal::getOdds($lottery_name,"总和龙虎和");
...
\'<input type="hidden" name="MyRtype" value="506"/>\'+
...
\'<div id="SendB5">\'+
    ...
    \'</div>\'+
\'</form>\';
document.getElementById("c_rtype").innerHTML = "总和龙虎和";
document.getElementById("sRtype").value = "506";
