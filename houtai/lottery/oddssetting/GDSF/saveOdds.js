function saveOdds(){
    ...
    function saveGeneralOdds(){
        $.ajax({
            type: "POST",
            url: "../lottery/oddssetting/GDSF/save/saveGeneralOdds.php",
            data: {
    ...
    function saveNumberOdds(){
        $.ajax({
            type: "POST",
            url: "../lottery/oddssetting/GDSF/save/saveNumberOdds.php",
            data: {
    ...
    function saveSeasonsOdds(){
        $.ajax({
            type: "POST",
            url: "../lottery/oddssetting/GDSF/save/saveSeasonsOdds.php",
            data: {
    ...
    function saveZfbOdds(){
        $.ajax({
            type: "POST",
            url: "../lottery/oddssetting/GDSF/save/saveZfbOdds.php",
            data: {
    ...
    function saveTigerOdds(){
        $.ajax({
            type: "POST",
            url: "../lottery/oddssetting/GDSF/save/saveTigerOdds.php",
            data: {
    ...
    function saveChooseOdds(){
        $.ajax({
            type: "POST",
            url: "../lottery/oddssetting/GDSF/save/saveChooseOdds.php",
            data: {
