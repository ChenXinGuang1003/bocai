...
elseif($_GET["action"]=="delete" && $id>0){
    ...
    $query	=	$mysqli->query($sql);
    //$row    =	$query->fetch_array();
    if($query){echo '<script>alert("删除成功"); window.href.location="/bh-100/Lottery/result/B5/result_b5.php?status=0&type=%E9%87%8D%E5%BA%86%E6%97%B6%E6%97%B6%E5%BD%A9";</script>';}
