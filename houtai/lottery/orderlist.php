                        ...
                        <tr>
                            <td align="center" bgcolor="#FFFFFF">
                                <select name="type" id="type">
                                 ...
                                 <!--    <option value="JX"    <?=$_GET['type']=='JX' ? 'selected' : ''?>>江西时时彩</option>1
                                    <option value="TJ"    <?=$_GET['type']=='TJ' ? 'selected' : ''?>>天津时时彩</option>1
                                    <option value="GDSF"  <?=$_GET['type']=='GDSF' ? 'selected' : ''?>>广东十分彩</option>1
                                    <option value="GXSF"  <?=$_GET['type']=='GXSF' ? 'selected' : ''?>>广西十分彩</option>1
                                    <option value="TJSF"  <?=$_GET['type']=='TJSF' ? 'selected' : ''?>>天津十分彩</option>1
                                    <option value="CQSF"  <?=$_GET['type']=='CQSF' ? 'selected' : ''?>>重庆十分彩</option>1 -->
                                    <option value="BJKN"  <?=$_GET['type']=='BJKN' ? 'selected' : ''?>>北京快乐8</option>
                                    <option value="BJPK"  <?=$_GET['type']=='BJPK' ? 'selected' : ''?>>北京PK拾</option>
                                 <!--    <option value="GD11"  <?=$_GET['type']=='GD11' ? 'selected' : ''?>>广东11选5</option>1 -->
                                    <option value="D3"    <?=$_GET['type']=='D3' ? 'selected' : ''?>>3D彩</option>
                                    <option value="P3"    <?=$_GET['type']=='P3' ? 'selected' : ''?>>排列三</option>
                                    <!-- <option value="T3"    <?=$_GET['type']=='T3' ? 'selected' : ''?>>上海时时乐</option>1 -->
