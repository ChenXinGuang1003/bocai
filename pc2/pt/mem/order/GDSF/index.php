...
$page = getCommonIndex("广东十分彩", "GDSF", getContentDiv(0), $_SESSION["username"], $_SESSION["user_money"]);
...
function getContentDiv($yearNum){
    ...
    <div id="content">
        <div id="content-inner">
            <h2>
                广东十分彩 <a style="display: none;"
                    id="limitShow"
                    title="详细设定"
                    data-callback="self.memberCenter.limit"
                    href="/member/account/limit.php?gtype=GDSF">
            </a>
            </h2>
            ...
            <span
                ...
                <div id="view-groups">
                    <a title="主盘势" group="GENERAL" href="#/GDSF/GENERAL">主盘势</a> <a title="单码双面" group="NUMBER_OPPOSITE"
                                                                                    href="#/GDSF/NUMBER_OPPOSITE">单码双面</a>
                    <a title="四季五行" group="SEASONS_ELEMENTS" href="#/GDSF/SEASONS_ELEMENTS">四季五行</a> <a title="方位/中发白"
                                                                                                        group="DIRECTION_ZFB"
                                                                                                        href="#/GDSF/DIRECTION_ZFB">方位/中发白</a>
                    <a title="总和/龙虎" group="ALLSUM_DRAGON_TIGER" href="#/GDSF/ALLSUM_DRAGON_TIGER">总和/龙虎</a> <a title="一中一"
                                                                                                                group="CHOOSE_1_MATCH_1"
                                                                                                                href="#/GDSF/CHOOSE_1_MATCH_1">一中一</a>
                </div>
