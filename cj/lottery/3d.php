...
<body>
    ...
    <div class="button">
        	<ul>
                ...
                <li class="gz"><a  href="sm/3d.php" title="游戏规则" target="_blank"></a></li>
            </ul>
    </div>
...
<div class="jsq">
    <span class="time">第 <font id="open_qihao">00000000-000</font> 期
        ...
        <span class="jd3dpl3"><a onclick="click_url('/member/b3/b3.php?gtype=D3&amp;rtype=W1')"  href="javascript:void(0);" title="经典3D">经典3d</a></span>
    <span class="ssc">福彩3D
