...
<div id="new_left" style="display: block;">
    <div class="new_left_cn" style=" float: left; padding-top: 0px;" id="Left_scroll">
        <div id="ds_01_bet">
...
<div class="jsq">
    ...
    <span class="ssc">天津时时彩
        第 <font id="numbers">00000000-000</font> 期</span>
        <span class="kjgz"><a  href="sm/sports.php" title="游戏规则" target="_blank">游戏规则</a></span>
  ...
  <span class="kjjj" ><a  href="/member/final/LT_result.php?gtype=TJ" title="开奖结果" target="_blank" >开奖结果</a></span>
</div>
