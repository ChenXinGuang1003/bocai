...
<body>
    ...
    <div class="button">
        	<ul>
                ...
                <li class="gz"><a  href="sm/pl3.php" title="游戏规则" target="_blank"></a></li>
            </ul>
    </div>
...
<div class="jsq">
    <span class="time">第 <font id="open_qihao">00000000-000</font> 期
        剩余<font id="whataction">投注</font>时间</span>
         <span class="jd3dpl3"><a onclick="click_url('/member/b3/b3.php?gtype=P3&amp;rtype=W1')"  href="javascript:void(0);"  title="经典排列三"ss >经典排列3</a></span>
    <span class="ssc">排列三
