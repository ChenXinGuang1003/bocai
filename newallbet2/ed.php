...
//$act=trim($_POST['act']);
				...
				if($agusername==""){//start
									...
									$regstatus = $bbinapi->GameUserRegister($agusername, $agpassword);
									//echo $regstatus;
...
<table border="0" cellspacing="10" cellpadding="0" width="600">
    ...
    <tr>
        ...
        <td>
            <select name="trtype" id="trtype">
                <option value="1">主钱包/体育/彩票账户->ALLBET大厅</option>
                <option value="2">ALLBET大厅->主钱包/体育/彩票账户</option>
            </select>
        </td>
    </tr>
    <tr>
 ...
 <script language="javascript">
	...
	function ab_change(bbmoney,bbtype){
		$('#p3_Amt').val(bbmoney);
		if(bbtype){
			$('#trtype').val(1);
		}else{
