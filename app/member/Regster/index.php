...
.nr_zc{background: url("/pic/page_body_bg.jpg") repeat-y scroll left top; color:#FFF; height:673px;width:1080px;margin:auto;}
</style>
</head>
<body>
<!---->
<div style="width:1263px;min-height:300px;background:url('about_wel.png') center;margin:auto;"></div>
<div style="width:1263px;min-height:300px;background:url('about_top.png')no-repeat center;margin:-79px auto;"></div>
<!---->
...
background: url(about_left.png) no-repeat center 0px;
}
 .left_list {
...
<div class="about_left">
    <div class="left_list">
        ...
        <a href="javascript:;">历史公告</a>
        <a href="javascript:;">玩法规则</a>
        <a href="javascript:click_url('/app/member/help/dlhz3.php');">加盟代理</a>
    </div>
</div>

<div style="width:1081px;height:89px;background:url('about_bg01.png') center;margin:auto;"></div>
...
<script language="javascript" src="/images/swfobject_source.js"></script>
				...
				-->
<h3 class="memCash_tit">【澳门永利】欢迎您的加入,官方网址：www.yl00853.com</h3>
...
<form target="_self" method="post" name="myFORM" id="myFORM" class="JoinMemForm" action="/app/member/Regster/save.php">
       ...
       <!--  <legend >注册帐号</legend>   -->  
            ...
            <!-- 介紹人 -->
             ...
             <label>介绍人：</label>
             <input type="text" name="agent_name" value="<?=$_SESSION["agent_name"]?>"  size="15" maxlength="20" />
            ...
            <p style="padding:7px 0px;">
				...
				&nbsp;&nbsp;&nbsp;帐号：请输入4-12个字元, 仅可输入英文字母以及数字的组合!!
            </p>

            <!-- 密碼 -->
            <p style="padding: 7px 0px;">
                <label><span class="star">*&nbsp;</span>密 码：</label>
                <input type="password" name="password" id="password" value="" class="password_adv" size="15" maxlength="12" />
				&nbsp;&nbsp;&nbsp;*密码规则：须为<font color='red'><b>6~12码英文或数字</b></font>且符合0~9或a~z字元
             </p>
            
           <!-- 確認密碼 -->
               <p style="margin-left: -20px;padding: 7px 0px;">
        ...
        <!--次要資料-->
        <fieldset>
       <!--  <legend style="padding: 10px 0px;">会员资料</legend>  -->    
            <p style="position:relative;height:1px;"><a style="position:absolute;top:0px;"></a></p>
                        <!-- 真實姓名 -->
            <p style="margin-left: -20px;padding: 7px 0px;">
				...
				&nbsp;&nbsp;&nbsp;必须与您的银行帐户名称相同，否则不能出款!
            </p>
           
                                                                                                <!-- 手機 -->
            <p style="margin-left: 4px;padding:7px 0px;">
            ...
            <div style="height: 6px;"></div>
           <!-- 取款密碼 -->
            <p style="padding: 7px 0px;margin-left: -20px;">
			...
			提款认证必须，请务必记住!
                                    ...
                                    <!-- QQ -->
            <p style="margin-left: 18px;padding: 10px 0px;">
                <label>QQ：</label>
            ...
            <!-- 備註 -->
            <div id="memCash-remark" align="left" style="margin: 20px 20px;">备注：
                <ul>
...
<div style="width: 1081px;
    height: 44px;
    background: url('about_bg03.png') center no-repeat;
    margin: -41px auto;"></div>
