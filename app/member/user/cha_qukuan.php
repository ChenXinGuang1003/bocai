...
$sql	=	"select id,order_value,order_num,update_time,user_id,assets,status,about from money where `user_id`='".$_SESSION["userid"]."' and (type='用户提款' or type='后台扣款') and `update_time`>='$get_time' order by id desc";
...
<div id="MACenterContent">
    ...
    <div id="MNavLv2">
        ...
        <span class="MGameType MCurrentType" onclick="chgType('cqRecord');">存取款记录</span>｜
    </div>
