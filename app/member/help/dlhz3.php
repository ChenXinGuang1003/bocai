    ...
    <div class="about_main_w">
        ...
        <div class="about_main">
			    ...
			    <div id="articles">
			      ...
			      <div id="Union" class="redborder">
			        <ul class="mtab-menual">
					  ...
					  <li><a class="icos" href="http://www.yl00853.com/agent/agent_login.php" target="_blank">代理登陆</a></li><!-- http://<?=$row["conf_www"]?> -->
			        </ul>
			        <div id="Union1">
			...
			<font face="微软雅黑"><strong>代理方案 </strong></font>
								<p><font face="微软雅黑">
								提供高额合作回报率，加入<?=$web_site['web_name']?>合作伙伴计划无需任何费用，不需承担任何风险。只要您介绍会员到本公司，您就可以获得我们净赢利的回报。 
								...
								<p><font face="微软雅黑">
								[代理注册]请联系代理专员提出申请，并确实填写各项资料。<?=$web_site['web_name']?>会评估审核联盟申请讯息，由专员与您联系开通，并提供您的注册帐号、密码及推广链接。</font></p>
																<table style="width: 680px; height: 261px" border="1" cellSpacing="1" cellPadding="1">
																	...
																	<tr>
																		<td colSpan="5">
																		<font face="微软雅黑">
																		注：<?=$web_site['web_name']?>保留上述条例之最终更改权！<br>
																...
																：2152963280</font></p>
																<p><font face="微软雅黑">
																代理专员邮箱：2152963280@qq.com</font></p>
																<p><font face="微软雅黑">
																...
																<p><font face="微软雅黑">● 
																相应费用包括：会员各项优惠、存/取款相应手续费(请留意：<?=$web_site['web_name']?>会员重复出款￥手续费/未达100%投注出款的手续费由会员吸收，不纳入计算)。</font></p>
																<p><font face="微软雅黑">
