function setbet(typename_in,touzhuxiang_in,match_id_in,point_column_in,ben_add_in,is_lose_in,xx_in){
    ...
    $.post("/app/member/ajaxleft/other_match.php",{ball_sort:typename_in,match_id:match_id_in,touzhuxiang:touzhuxiang_in,point_column:point_column_in,ben_add:ben_add_in,xx:xx_in,checked:checked,rand:Math.random()},function (data){  parent.leftFrame.bet(data); }); 
}
