...
*/
		...
		if(isSubmitButton){
			_jd_dialog_m_t.append("<span class='jd_dialog_m_t_s'><input id='jd_submit' style='background-color: blue;' value='"+JqueryDialog.cSubmitText+"' type='button' onclick='JqueryDialog.Ok();' class='button1' /></span>");
		}
		_jd_dialog_m_t.append("<span class='jd_dialog_m_t_s'><input id='jd_fx' style='background-color: blue;' value='反选' type='button' class='button1' onclick='JqueryDialog.fx();' /></span>");
		if(isCancelButton){
			_jd_dialog_m_t.append("<span class='jd_dialog_m_t_s'><input id='jd_cancel' style='background-color: blue;' value='"+JqueryDialog.cCancelText+"' type='button' onclick='JqueryDialog.cx();' class='button1' /></span>");
		}
