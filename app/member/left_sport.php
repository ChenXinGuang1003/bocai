...
<body onload="initialMenu();">
    ...
    <!--sport menu-->
    <div class="item" id="subnav_head" style="background:url(/imgs/div_left_16.gif) center center repeat-x !important; width:100% !important;" >
        <table width="100%">
            <tr>
    ...
    <!--Today and Early-->
    <div id="subnav" style="width:100% !important;">
