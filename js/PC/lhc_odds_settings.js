(function (space) {
    ...
    //遊戲分頁
    var _tab = [
                  { 660:Lang('l_606'),661:Lang('l_607'),662:Lang('l_608'),663:Lang('l_609'),664:Lang('l_610'),665:Lang('l_611'),666:Lang('l_605'),667:Lang('l_612') },
                  { 671:Lang('l_606'),672:Lang('l_607'),673:Lang('l_608'),674:Lang('l_609'),675:Lang('l_610'),676:Lang('l_611') },
                  { 605:Lang('l_613'),670:Lang('l_614'),606:Lang('l_606'),607:Lang('l_607'),608:Lang('l_608'),609:Lang('l_609'),610:Lang('l_610'),611:Lang('l_611'),612:Lang('l_612') },
                  { 621:Lang('l_621'),624:Lang('l_624')},
                  { 681:Lang('l_681'),682:Lang('l_682'),683:Lang('l_683'),684:Lang('l_684')},
                  { 685:Lang('l_685'),686:Lang('l_686'),687:Lang('l_687'),688:Lang('l_688')},
                  { 631:Lang('l_631'),632:Lang('l_632'),633:Lang('l_633'),634:Lang('l_634'),635:Lang('l_635') },
                  { 641:Lang('l_641'),642:Lang('l_642'),643:Lang('l_643'),644:Lang('l_644') },
                  { 651:Lang('l_651'),652:Lang('l_652') },
    ...
    //快選rtype
    var _rtypeQuick = ['595', '596', '597','598', '599', '600','501','502','503','605','514','515','516','514','515','516','517','518','519','520','521','532','533','534','616','617','618','522','523','524','525','526','527','528','529','530','531'];
    ...
    var _config = {
        url : {
            ...
            switch_g : 'action.php',
            switch_a : 'oddssetting/LHC/quick_action.php'
        },
        reg : {
            ...
            grp_d1 : /^(605|501|502|503|517|518|519|520|521)$/,
    ...
    function _checkShow(rtype) {
        var _check = [
                         ...
                         ['605', '670', '606', '607', '608', '609', '610', '611',  '612'],
                         ['621', '624'],
                         ['681', '682', '683', '684'],
                         ['685', '686', '687', '688'],
                         ['631', '632', '633', '634', '635'],
        ...
        init : function () {
            ...
            if (this.grpBtn != null) {
                if ($.inArray(this._rtype, _rtypeQuick) >= 0) {
                    ...
                    var _rtypeW1 = ['605','501','502','503','517','518','519','520','521'];
