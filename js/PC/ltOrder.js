...
(function(space){
    ...
    space.bet.prototype = {
        ...
        init : function () {
            ...
            var _form = $(_opt.wap_selector.form);
			}else{
			var _form = $(_opt.selector.form);
			}
            
            var _gold = _form.find(_opt.selector.gold),
        ...
        initLx : function () {
            ...
            this._btnCancel = _cancel.get(0);
			//alert(13);
			//alert(_opt.selector.form);
            this._btnSend = _submit.get(0);
			//alert(14);
			//alert(JSON.stringify(this._btnSend));
            this._goldInp.onkeypress = this.onGoldKp;
			//alert(15);
            this._goldInp.onkeyup = function () {
            ...
            var _btn = this, _this = me, _fn = function () {
                ...
                $.ajax({
                    ...
                    success: function(response){
                        ...
                        new_alert(Lang('OperateSuccess'));//_this._form.action+sLang('OperateSuccess')+'_1_'+response
            ...
            var _ok = this._btnSend, _no = this._btnCancel, _form = this._form, me = this, _fn = function () {
                ...
                $.ajax({
                    ...
                    success: function(response){
                        ...
                        new_alert(Lang('OperateSuccess'));//new_alert(Lang('OperateSuccess')+'_2_'+$(_this._form).serialize());
                        document.getElementById("bet-credit").innerHTML = response;
                    }
                });
            };
            ...
            var _ok = this._btnSend, _no = this._btnCancel, _form = this._form, me = this, _fn = function () {
                ...
                $.ajax({
                    ...
                    success: function(response){
                        ...
                        new_alert(Lang('OperateSuccess'));//new_alert(Lang('OperateSuccess')+'_3_'+$(_this._form).serialize());
                        document.getElementById("bet-credit").innerHTML = response;
                    }
                });
            };
...
//                }
            ...
            var _this = me, _form = this, _ok = function () {
                ...
                $.ajax({
                    ...
                    success: function(response){
						new_alert(Lang('OperateSuccess'));//new_alert(_form.action+Lang('OperateSuccess')+'_4s_'+response);
                        if(document.newForm){
                            document.newForm.reset();
                        }
