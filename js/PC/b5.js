(function (space) {
    ...
    var _rtypeOther = ['595', '596', '597', '598', '599', '600', '514','515','516','532','533','534'];
    //組選三
    var _rtypeGST = ['595', '596', '597'];
    //組選六
    var _rtypeGSS = ['598', '599', '600'];
    //三字定位
    var _rtypeD3 = ['532','533','534'];
    //快選rtype
    var _rtypeQuick = ['501','502','503','605','514','515','516','514','515','516','517','518','519','520','521','532','533','534','616','617','618','522','523','524','525','526','527','528','529','530','531'];
    ...
    space.GameB5.prototype = {
        ...
        onQuickDivShow : function () {
            ...
            if (_rtype == 'W32' || _rtype == 'W33') {
                $('#B5W3quick').show();
            } else if ($.inArray(_rtype, _rtype3) >= 0) {
                $('#B5D3quick').show();
            } else {
                $('#B5D2quick').show();
            }
