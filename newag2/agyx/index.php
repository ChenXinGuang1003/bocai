                        ...
                        <div class="games-item clearfix">
                            ...
                            <ul class="clearfix">
                                <li>
                                    ...
                                    <div class="game-rollover clearfix"><a class="real-play" href="/newag2/index.html" onclick="if(<?echo($_SESSION['username']==''?'true':'false')?>){alert('请先登录');return false;}" target="_blank" >立刻开始</a></div>
                                </li>
