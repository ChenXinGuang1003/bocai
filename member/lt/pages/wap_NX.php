...
window.onload = function(){
  ...
  <style>
	#table2{height:23rem}
	tr{ height:50px!important;height:100%}
	td{font-size:1.5em!important;height:5rem}
...
下注金额 :
    ...
    <p style="clear:both">
      ...
      <input id="QuickSubmit" type="button" value="确定" />
              ...
              <div id="Game">
                            <form name="lt_form" method="post" action="/member/lt_nx/lt_nx_order.php?cl=wap" onsubmit="return false;"  style="  width: 100%!important;">
