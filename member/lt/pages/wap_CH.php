...
window.onload = function(){
  ...
  //-->
   ...
   <style>
	...
	td{font-size:2em!important;}
<!-- 	#SPA_Box,#Dantuo h3{    height: 30px!important;line-height: 30px;} -->
...
下注金额 :
    ...
    <p style="clear:both">
      ...
      <input id="QuickSubmit" type="button" value="确定" />
              ...
              <div id="Game" style=" width:100%!important;">
                            <form name="lt_form" method="post" action="/member/lt_ch/lt_ch_order.php" onsubmit="return false;" class="Aside" style=" width:100%!important;">
...
类别
        ...
        <td>
          ...
          <input name="rtype" type="radio" value="CH_4" />四全我中
          </label>
        </td>
        <td>
          <label class="padding_label">
...
<div id="ShowRule">
  ...
  <div id="message_box" style="display:none; position:absolute; top:50%;left:20%; background-color:#EBEBEB;  margin-top:-150px;width:60%;"></div>
