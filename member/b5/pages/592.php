...
$odds = odds_lottery_normal::getOdds($lottery_name,"(前三)和尾数");
...
<div id="content_inner">
    ...
    <div>
        ...
        <div id="wager_groups" class="'.$gType.'">
            ...
            <a href="/member/b5/b5.php?gtype='.$gType.'&amp;rtype=592" class="NowPlay" title="和尾数">和尾数</a>
...
<div id="tab" >
    <ul>
        <li class="onTagClick"><span class="592"><b>前三</b></span></li>
        <li class="unTagClick"><span class="593"><b>中三</b></span></li>
        <li class="unTagClick"><span class="594"><b>后三</b></span></li>
        <li class="unTagClick"><span class="606"><b>万仟</b></span></li>
        <li class="unTagClick"><span class="607"><b>万佰</b></span></li>
        <li class="unTagClick"><span class="608"><b>万拾</b></span></li>
        <li class="unTagClick"><span class="609"><b>万个</b></span></li>
        <li class="unTagClick"><span class="610"><b>仟佰</b></span></li>
        <li class="unTagClick"><span class="611"><b>仟拾</b></span></li>
        <li class="unTagClick"><span class="612"><b>仟个</b></span></li>
        <li class="unTagClick"><span class="613"><b>佰拾</b></span></li>
        <li class="unTagClick"><span class="614"><b>佰个</b></span></li>
        <li class="unTagClick"><span class="615"><b>拾个</b></span></li>
        <li id="space"></li>
    </ul>
</div>
...
<input type="hidden" name="MyRtype" value="592" />
    ...
    <table class="GameTable">
        ...
        <tr>
            ...
            <td class="num" style="width:30px">
                ...
                <input type="hidden" name="aConcede[]" value="592-0"/>
            </td>
            <td class="odds">
                <label for="592-0" class="odds">
                    '.$odds["h0"].'
                </label>
                <input type="hidden" name="aOdds[]" value="'.$odds["h0"].'"/>
            </td>
            <td class="odds" style="width:60px">
                <input type="text" pattern="[0-9]*" min="0" max="99999999" class="G" name="gold[]" id="592-0"/>
            </td>
            ...
            <td class="num" style="width:30px">
                ...
                <input type="hidden" name="aConcede[]" value="592-1"/>
            </td>
            <td class="odds">
                <label for="592-1" class="odds">
                    '.$odds["h1"].'
                </label>
                <input type="hidden" name="aOdds[]" value="'.$odds["h1"].'"/>
            </td>
            <td class="odds" style="width:60px">
                <input type="text" pattern="[0-9]*" min="0" max="99999999" class="G" name="gold[]" id="592-1"/>
            </td>
            ...
            <td class="num" style="width:30px">
                ...
                <input type="hidden" name="aConcede[]" value="592-2"/>
            </td>
            <td class="odds">
                <label for="592-2" class="odds">
                    '.$odds["h2"].'
                </label>
                <input type="hidden" name="aOdds[]" value="'.$odds["h2"].'"/>
            </td>
            <td class="odds" style="width:60px">
                <input type="text" pattern="[0-9]*" min="0" max="99999999" class="G" name="gold[]" id="592-2"/>
            </td>
            ...
            <td class="num" style="width:30px">
                ...
                <input type="hidden" name="aConcede[]" value="592-3"/>
            </td>
            <td class="odds">
                <label for="592-3" class="odds">
                    '.$odds["h3"].'
                </label>
                <input type="hidden" name="aOdds[]" value="'.$odds["h3"].'"/>
            </td>
            <td class="odds" style="width:60px">
                <input type="text" pattern="[0-9]*" min="0" max="99999999" class="G" name="gold[]" id="592-3"/>
            </td>
            ...
            <td class="num" style="width:30px">
                ...
                <input type="hidden" name="aConcede[]" value="592-4"/>
            </td>
            <td class="odds">
                <label for="592-4" class="odds">
                    '.$odds["h4"].'
                </label>
                <input type="hidden" name="aOdds[]" value="'.$odds["h4"].'"/>
            </td>
            <td class="odds" style="width:60px">
                <input type="text" pattern="[0-9]*" min="0" max="99999999" class="G" name="gold[]" id="592-4"/>
            </td>
        ...
        <tr>
            <td class="num" style="width:30px">
                ...
                <input type="hidden" name="aConcede[]" value="592-5"/>
            </td>
            <td class="odds">
                <label for="592-5" class="odds">
                    '.$odds["h5"].'
                </label>
                <input type="hidden" name="aOdds[]" value="'.$odds["h5"].'"/>
            </td>
            <td class="odds" style="width:60px">
                <input type="text" pattern="[0-9]*" min="0" max="99999999" class="G" name="gold[]" id="592-5"/>
            </td>
            ...
            <td class="num" style="width:30px">
                ...
                <input type="hidden" name="aConcede[]" value="592-6"/>
            </td>
            <td class="odds">
                <label for="592-6" class="odds">
                    '.$odds["h6"].'
                </label>
                <input type="hidden" name="aOdds[]" value="'.$odds["h6"].'"/>
            </td>
            <td class="odds" style="width:60px">
                <input type="text" pattern="[0-9]*" min="0" max="99999999" class="G" name="gold[]" id="592-6"/>
            </td>
            ...
            <td class="num" style="width:30px">
                ...
                <input type="hidden" name="aConcede[]" value="592-7"/>
            </td>
            <td class="odds">
                <label for="592-7" class="odds">
                    '.$odds["h7"].'
                </label>
                <input type="hidden" name="aOdds[]" value="'.$odds["h7"].'"/>
            </td>
            <td class="odds" style="width:60px">
                <input type="text" pattern="[0-9]*" min="0" max="99999999" class="G" name="gold[]" id="592-7"/>
            </td>
            ...
            <td class="num" style="width:30px">
                ...
                <input type="hidden" name="aConcede[]" value="592-8"/>
            </td>
            <td class="odds">
                <label for="592-8" class="odds">
                    '.$odds["h8"].'
                </label>
                <input type="hidden" name="aOdds[]" value="'.$odds["h8"].'"/>
            </td>
            <td class="odds" style="width:60px">
                <input type="text" pattern="[0-9]*" min="0" max="99999999" class="G" name="gold[]" id="592-8"/>
            </td>
            ...
            <td class="num" style="width:30px">
                ...
                <input type="hidden" name="aConcede[]" value="592-9"/>
            </td>
            <td class="odds">
                <label for="592-9" class="odds">
                    '.$odds["h9"].'
                </label>
                <input type="hidden" name="aOdds[]" value="'.$odds["h9"].'"/>
            </td>
            <td class="odds" style="width:60px">
                <input type="text" pattern="[0-9]*" min="0" max="99999999" class="G" name="gold[]" id="592-9"/>
            </td>
...
<input type="hidden" id="sRtype" name="sRtype" value="592"/>
<input type="hidden" id="sGtype" name="sGtype" value="'.$gType.'"/>
<input type="hidden" name="iTime" id="iTime" value="1393816716"/>
</div>
</div>
</div>
</div>
