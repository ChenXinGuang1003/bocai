...
$odds = odds_lottery_normal::getOdds($lottery_name,"万定位");
...
<div id="content_inner">
    ...
    <div>
        ...
        <div id="wager_groups" class="'.$gType.'">
            ...
            <a href="/member/b5/b5.php?gtype='.$gType.'&amp;rtype=517" class="NowPlay" title="一字定位">一字定位</a>
...
<div id="tab" >
    <ul>
        <li class="onTagClick"><span class="517"><b>万</b></span></li>
        <li class="unTagClick"><span class="518"><b>仟</b></span></li>
        <li class="unTagClick"><span class="519"><b>佰</b></span></li>
        <li class="unTagClick"><span class="520"><b>拾</b></span></li>
        <li class="unTagClick"><span class="521"><b>个</b></span></li>
        <li id="space"></li>
    </ul>
</div>
...
<input type="hidden" name="MyRtype" value="517" />
    ...
    <table class="GameTable">
        ...
        <tr>
            ...
            <td class="num" style="width:30px">
                ...
                <input type="hidden" name="aConcede[]" value="517-0"/>
            </td>
            <td class="odds">
                <label for="517-0" class="odds">
                    '.$odds["h0"].'
                </label>
                <input type="hidden" name="aOdds[]" value="'.$odds["h0"].'"/>
            </td>
            <td class="odds" style="width:60px">
                <input type="text" pattern="[0-9]*" min="0" max="99999999" class="G" name="gold[]" id="517-0"/>
            </td>
            ...
            <td class="num" style="width:30px">
                ...
                <input type="hidden" name="aConcede[]" value="517-1"/>
            </td>
            <td class="odds">
                <label for="517-1" class="odds">
                    '.$odds["h1"].'
                </label>
                <input type="hidden" name="aOdds[]" value="'.$odds["h1"].'"/>
            </td>
            <td class="odds" style="width:60px">
                <input type="text" pattern="[0-9]*" min="0" max="99999999" class="G" name="gold[]" id="517-1"/>
            </td>
            ...
            <td class="num" style="width:30px">
                ...
                <input type="hidden" name="aConcede[]" value="517-2"/>
            </td>
            <td class="odds">
                <label for="517-2" class="odds">
                    '.$odds["h2"].'
                </label>
                <input type="hidden" name="aOdds[]" value="'.$odds["h2"].'"/>
            </td>
            <td class="odds" style="width:60px">
                <input type="text" pattern="[0-9]*" min="0" max="99999999" class="G" name="gold[]" id="517-2"/>
            </td>
            ...
            <td class="num" style="width:30px">
                ...
                <input type="hidden" name="aConcede[]" value="517-3"/>
            </td>
            <td class="odds">
                <label for="517-3" class="odds">
                    '.$odds["h3"].'
                </label>
                <input type="hidden" name="aOdds[]" value="'.$odds["h3"].'"/>
            </td>
            <td class="odds" style="width:60px">
                <input type="text" pattern="[0-9]*" min="0" max="99999999" class="G" name="gold[]" id="517-3"/>
            </td>
            ...
            <td class="num" style="width:30px">
                ...
                <input type="hidden" name="aConcede[]" value="517-4"/>
            </td>
            <td class="odds">
                <label for="517-4" class="odds">
                    '.$odds["h4"].'
                </label>
                <input type="hidden" name="aOdds[]" value="'.$odds["h4"].'"/>
            </td>
            <td class="odds" style="width:60px">
                <input type="text" pattern="[0-9]*" min="0" max="99999999" class="G" name="gold[]" id="517-4"/>
            </td>
        ...
        <tr>
            <td class="num" style="width:30px">
                ...
                <input type="hidden" name="aConcede[]" value="517-5"/>
            </td>
            <td class="odds">
                <label for="517-5" class="odds">
                    '.$odds["h5"].'
                </label>
                <input type="hidden" name="aOdds[]" value="'.$odds["h5"].'"/>
            </td>
            <td class="odds" style="width:60px">
                <input type="text" pattern="[0-9]*" min="0" max="99999999" class="G" name="gold[]" id="517-5"/>
            </td>
            ...
            <td class="num" style="width:30px">
                ...
                <input type="hidden" name="aConcede[]" value="517-6"/>
            </td>
            <td class="odds">
                <label for="517-6" class="odds">
                    '.$odds["h6"].'
                </label>
                <input type="hidden" name="aOdds[]" value="'.$odds["h6"].'"/>
            </td>
            <td class="odds" style="width:60px">
                <input type="text" pattern="[0-9]*" min="0" max="99999999" class="G" name="gold[]" id="517-6"/>
            </td>
            ...
            <td class="num" style="width:30px">
                ...
                <input type="hidden" name="aConcede[]" value="517-7"/>
            </td>
            <td class="odds">
                <label for="517-7" class="odds">
                    '.$odds["h7"].'
                </label>
                <input type="hidden" name="aOdds[]" value="'.$odds["h7"].'"/>
            </td>
            <td class="odds" style="width:60px">
                <input type="text" pattern="[0-9]*" min="0" max="99999999" class="G" name="gold[]" id="517-7"/>
            </td>
            ...
            <td class="num" style="width:30px">
                ...
                <input type="hidden" name="aConcede[]" value="517-8"/>
            </td>
            <td class="odds">
                <label for="517-8" class="odds">
                    '.$odds["h8"].'
                </label>
                <input type="hidden" name="aOdds[]" value="'.$odds["h8"].'"/>
            </td>
            <td class="odds" style="width:60px">
                <input type="text" pattern="[0-9]*" min="0" max="99999999" class="G" name="gold[]" id="517-8"/>
            </td>
            ...
            <td class="num" style="width:30px">
                ...
                <input type="hidden" name="aConcede[]" value="517-9"/>
            </td>
            <td class="odds">
                <label for="517-9" class="odds">
                    '.$odds["h9"].'
                </label>
                <input type="hidden" name="aOdds[]" value="'.$odds["h9"].'"/>
            </td>
            <td class="odds" style="width:60px">
                <input type="text" pattern="[0-9]*" min="0" max="99999999" class="G" name="gold[]" id="517-9"/>
            </td>
...
<input type="hidden" id="sRtype" name="sRtype" value="517"/>
<input type="hidden" id="sGtype" name="sGtype" value="'.$gType.'"/>
<input type="hidden" name="iTime" id="iTime" value="1393817404"/>
</div>
</div>
</div>
</div>
