...
<div id="content_inner">
    ...
    <div>
        ...
        <div id="wager_groups" class="'.$gType.'">
            ...
            <a href="/member/b5/b5.php?gtype='.$gType.'&amp;rtype=598" class="NowPlay" title="组选六">组选六</a>
...
<div id="tab" >
    <ul>
        <li class="onTagClick"><span class="598"><b>前三</b></span></li>
        <li class="unTagClick"><span class="599"><b>中三</b></span></li>
        <li class="unTagClick"><span class="600"><b>后三</b></span></li>
        <li id="space"></li>
    </ul>
</div>
...
<div id="GrpBtnB5" style="display:none">
    ...
    <form id="formB5" name="CQ_022" action="../D3_order.php" method="post" target="_top" onsubmit="return false;">
        ...
        <input type="hidden" name="MyRtype" value="598" />
...
<input type="hidden" id="sRtype" name="sRtype" value="598" />
<input type="hidden" id="sGtype" name="sGtype" value="'.$gType.'" />
<input type="hidden" name="iTime" id="iTime" value="1393817075" />
</div>
</div>
</div>
</div>
