...
$odds = odds_lottery_normal::getOdds($lottery_name,"(前三)跨度");
...
<div id="content_inner">
    ...
    <div>
        ...
        <div id="wager_groups" class="'.$gType.'">
            ...
            <a href="/member/b5/b5.php?gtype='.$gType.'&amp;rtype=589" class="NowPlay" title="跨度">跨度</a>
        </div>
    </div>
</div>
<!--rtype选择-->
...
<div id="tab" >
    <ul>
        <li class="onTagClick"><span class="589"><b>前三</b></span></li>
        <li class="unTagClick"><span class="590"><b>中三</b></span></li>
        <li class="unTagClick"><span class="591"><b>后三</b></span></li>
        <li id="space"></li>
    </ul>
</div>
...
<input type="hidden" name="MyRtype" value="589" />
<input type="hidden" name="gtype" value="'.$gType.'" />

<input type="hidden" name="gold_gmax" class="589100" value="'.$maxMoney.'" />
<input type="hidden" name="gold_gmin" class="589100" value="'.$lowestMoney.'" />
<input type="hidden" name="SC" class="589100" value="50000" />
<input type="hidden" name="SO" class="589100" value="1000" />
    ...
    <table class="GameTable">
        ...
        <tr>
            ...
            <td class="num" style="width:30px">
                ...
                <input type="hidden" name="aConcede[]" value="589-0"/>
            </td>
            <td class="odds">
                <label for="589-0" class="odds">
                    '.$odds["h0"].'
                </label>
                <input type="hidden" name="aOdds[]" value="'.$odds["h0"].'"/>
            </td>
            <td class="odds" style="width:60px">
                <input type="text" pattern="[0-9]*" min="0" max="99999999" class="G" name="gold[]" id="589-0"/>
            </td>
            ...
            <td class="num" style="width:30px">
                ...
                <input type="hidden" name="aConcede[]" value="589-1"/>
            </td>
            <td class="odds">
                <label for="589-1" class="odds">
                    '.$odds["h1"].'
                </label>
                <input type="hidden" name="aOdds[]" value="'.$odds["h1"].'"/>
            </td>
            <td class="odds" style="width:60px">
                <input type="text" pattern="[0-9]*" min="0" max="99999999" class="G" name="gold[]" id="589-1"/>
            </td>
            ...
            <td class="num" style="width:30px">
                ...
                <input type="hidden" name="aConcede[]" value="589-2"/>
            </td>
            <td class="odds">
                <label for="589-2" class="odds">
                    '.$odds["h2"].'
                </label>
                <input type="hidden" name="aOdds[]" value="'.$odds["h2"].'"/>
            </td>
            <td class="odds" style="width:60px">
                <input type="text" pattern="[0-9]*" min="0" max="99999999" class="G" name="gold[]" id="589-2"/>
            </td>
            ...
            <td class="num" style="width:30px">
                ...
                <input type="hidden" name="aConcede[]" value="589-3"/>
            </td>
            <td class="odds">
                <label for="589-3" class="odds">
                    '.$odds["h3"].'
                </label>
                <input type="hidden" name="aOdds[]" value="'.$odds["h3"].'"/>
            </td>
            <td class="odds" style="width:60px">
                <input type="text" pattern="[0-9]*" min="0" max="99999999" class="G" name="gold[]" id="589-3"/>
            </td>
            ...
            <td class="num" style="width:30px">
                ...
                <input type="hidden" name="aConcede[]" value="589-4"/>
            </td>
            <td class="odds">
                <label for="589-4" class="odds">
                    '.$odds["h4"].'
                </label>
                <input type="hidden" name="aOdds[]" value="'.$odds["h4"].'"/>
            </td>
            <td class="odds" style="width:60px">
                <input type="text" pattern="[0-9]*" min="0" max="99999999" class="G" name="gold[]" id="589-4"/>
            </td>
        ...
        <tr>
            <td class="num" style="width:30px">
                ...
                <input type="hidden" name="aConcede[]" value="589-5"/>
            </td>
            <td class="odds">
                <label for="589-5" class="odds">
                    '.$odds["h5"].'
                </label>
                <input type="hidden" name="aOdds[]" value="'.$odds["h5"].'"/>
            </td>
            <td class="odds" style="width:60px">
                <input type="text" pattern="[0-9]*" min="0" max="99999999" class="G" name="gold[]" id="589-5"/>
            </td>
            ...
            <td class="num" style="width:30px">
                ...
                <input type="hidden" name="aConcede[]" value="589-6"/>
            </td>
            <td class="odds">
                <label for="589-6" class="odds">
                    '.$odds["h6"].'
                </label>
                <input type="hidden" name="aOdds[]" value="'.$odds["h6"].'"/>
            </td>
            <td class="odds" style="width:60px">
                <input type="text" pattern="[0-9]*" min="0" max="99999999" class="G" name="gold[]" id="589-6"/>
            </td>
            ...
            <td class="num" style="width:30px">
                ...
                <input type="hidden" name="aConcede[]" value="589-7"/>
            </td>
            <td class="odds">
                <label for="589-7" class="odds">
                    '.$odds["h7"].'
                </label>
                <input type="hidden" name="aOdds[]" value="'.$odds["h7"].'"/>
            </td>
            <td class="odds" style="width:60px">
                <input type="text" pattern="[0-9]*" min="0" max="99999999" class="G" name="gold[]" id="589-7"/>
            </td>
            ...
            <td class="num" style="width:30px">
                ...
                <input type="hidden" name="aConcede[]" value="589-8"/>
            </td>
            <td class="odds">
                <label for="589-8" class="odds">
                    '.$odds["h8"].'
                </label>
                <input type="hidden" name="aOdds[]" value="'.$odds["h8"].'"/>
            </td>
            <td class="odds" style="width:60px">
                <input type="text" pattern="[0-9]*" min="0" max="99999999" class="G" name="gold[]" id="589-8"/>
            </td>
            ...
            <td class="num" style="width:30px">
                ...
                <input type="hidden" name="aConcede[]" value="589-9"/>
            </td>
            <td class="odds">
                <label for="589-9" class="odds">
                    '.$odds["h9"].'
                </label>
                <input type="hidden" name="aOdds[]" value="'.$odds["h9"].'"/>
            </td>
            <td class="odds" style="width:60px">
                <input type="text" pattern="[0-9]*" min="0" max="99999999" class="G" name="gold[]" id="589-9"/>
            </td>
...
<input type="hidden" id="sRtype" name="sRtype" value="589"/>
<input type="hidden" id="sGtype" name="sGtype" value="'.$gType.'"/>
<input type="hidden" name="iTime" id="iTime" value="1393817181"/>
</div>
</div>
</div>
</div>
