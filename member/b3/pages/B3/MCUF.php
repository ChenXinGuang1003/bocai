...
<div id="content_inner">
    ...
    <div>
        ...
        <div id="wager_groups" class="'.$gType.'">
            ...
            <a href="/member/b3/b3.php?gtype='.$gType.'&amp;rtype=MCUF" class="NowPlay" title="和尾数">和尾数</a>
...
<div id="tab" >
    <ul>
        <li class="onTagClick"><span class="MCUF"><b>口口口</b></span></li>
        <li class="unTagClick"><span class="MCF"><b>口口X</b></span></li>
        <li class="unTagClick"><span class="MUF"><b>口X口</b></span></li>
        <li class="unTagClick"><span class="CUF"><b>X口口</b></span></li>
        <li id="space"></li>
    </ul>
</div>
...
<input type="hidden" id="sRtype" name="sRtype" value="MCUF"/>
<input type="hidden" id="sGtype" name="sGtype" value="'.$gType.'"/>
<input type="hidden" name="iTime" id="iTime" value="1393482581"/>
</div>
</div>
</div>
</div>
