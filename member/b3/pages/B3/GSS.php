...
<div id="content_inner">
    ...
    <div>
        ...
        <div id="wager_groups" class="'.$gType.'">
            ...
            <a href="/member/b3/b3.php?gtype='.$gType.'&amp;rtype=GSS" class="NowPlay" title="组选六">组选六</a>
...
<div id="GrpBtnB3" style="display:none">
    ...
    <form id="formB3" name="D3_022" action="/member/D3_order.php" method="post" target="_top" onsubmit="return false;">
...
<input type="hidden" id="sRtype" name="sRtype" value="GSS" />
<input type="hidden" id="sGtype" name="sGtype" value="'.$gType.'" />
<input type="hidden" name="iTime" id="iTime" value="1393482726" />
</div>
</div>
</div>
</div>
