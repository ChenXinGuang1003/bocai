...
<head>
    ...
    <script src="/js/C2R.js?3569e86"></script>
    ...
    <script>
        ...
        $().ready(function(){
            ...
            self.GoldUI.installDrag("betMove", self.betSpace.betB3.onDragBet);
            ...
            $(".bb3d_video_link").click(function() {
                if(!bbwin || (bbwin && bbwin.closed)) {
                    bbwin = window.open("http://www.jh0444.com/cl/?module=MFunction&method=BB3DLive", "BBLIVE", "width=900, height=550, fullscreen=0, location=0, menubar=0, resizable=0, scrollbars=0, status=0")
                }
                bbwin.focus();
            });
        });
...
<div id="content_inner">
    ...
    <div>
        ...
        <div id="game_info">
            <span class="GameTime">第<span id="YearNum">034</span>期</span>&nbsp;&nbsp;
            <b>开奖日期:</b><span class="EndTime">2014-02-28 20:28:00</span>
        <span id="ui-countdown">
          <div id="FCDL">
            <span>
              <span id="FCDH">29:55:32</span>
              <span id="FCDS" style="display:none">107732</span>
            </span>
          </div>
        </span>
        </div>
        <div id="wager_groups" class="'.$gType.'">
            ...
            <a href="/member/b3/b3.php?gtype='.$gType.'&amp;rtype=WP" class="NowPlay" title="一字过关">一字过关</a>
...
<div id="GrpBtnB3" style="display:none">
    ...
    <div id="D3quick" class="InfoBar">
        ...
        <p class="cc">
            <input type="button" class="order" name="pickup" value="选取" />
            <input type="button" class="order" name="Clear" value="清除" />
            <input type="button" class="order" name="Cancel" value="取消" />
            <input type="button" class="order" name="order" value="确定" />
        </p>
    </div>
    ...
    <form id="formB3" name="D3_022" action="../D3_order.php" method="post" onsubmit="return false;">
        ...
        <div class="round-table">
            <table class="GameTable">
                ...
                <tr>
                    <td class="num">口XX</td>
                    <td class="odds" >
                        <span class="dd">'.$odds["h0"].'</span>
                        &nbsp;
                        <input type="radio" name="concede0" value="WPM_ODD" id="WPM_ODD"   />
                    </td>
                    <td class="odds" >
                        <span class="dd">'.$odds["h1"].'</span>&nbsp;
                        <input type="radio" name="concede0" value="WPM_EVEN" id="WPM_EVEN"  />
                    </td>
                    <td class="odds" >
                        <span class="dd">'.$odds["h2"].'</span>&nbsp;
                        <input type="radio" name="concede0" value="WPM_OVER" id="WPM_OVER"   />
                    </td>
                    <td class="odds" >
                        <span class="dd">'.$odds["h3"].'</span>&nbsp;
                        <input type="radio" name="concede0" value="WPM_UNDER" id="WPM_UNDER"  />
                    </td>
                    <td class="odds" >
                        <span class="dd">'.$odds["h4"].'</span>&nbsp;
                        <input type="radio" name="concede0" value="WPM_PRIME" id="WPM_PRIME"   />
                    </td>
                    <td class="odds" >
                        <span class="dd">'.$odds["h5"].'</span>&nbsp;
                        <input type="radio" name="concede0" value="WPM_COMPO" id="WPM_COMPO"  />
                    </td>
                </tr>
                <tr>
                    <td class="num">X口X</td>
                    <td class="odds" >
                        <span class="dd">'.$odds["h6"].'</span>
                        &nbsp;
                        <input type="radio" name="concede1" value="WPC_ODD" id="WPC_ODD"   />
                    </td>
                    <td class="odds" >
                        <span class="dd">'.$odds["h7"].'</span>&nbsp;
                        <input type="radio" name="concede1" value="WPC_EVEN" id="WPC_EVEN"  />
                    </td>
                    <td class="odds" >
                        <span class="dd">'.$odds["h8"].'</span>&nbsp;
                        <input type="radio" name="concede1" value="WPC_OVER" id="WPC_OVER"   />
                    </td>
                    <td class="odds" >
                        <span class="dd">'.$odds["h9"].'</span>&nbsp;
                        <input type="radio" name="concede1" value="WPC_UNDER" id="WPC_UNDER"  />
                    </td>
                    <td class="odds" >
                        <span class="dd">'.$odds["h10"].'</span>&nbsp;
                        <input type="radio" name="concede1" value="WPC_PRIME" id="WPC_PRIME"   />
                    </td>
                    <td class="odds" >
                        <span class="dd">'.$odds["h11"].'</span>&nbsp;
                        <input type="radio" name="concede1" value="WPC_COMPO" id="WPC_COMPO"  />
                    </td>
                </tr>
                <tr>
                    <td class="num">XX口</td>
                    <td class="odds" >
                        <span class="dd">'.$odds["h12"].'</span>
                        &nbsp;
                        <input type="radio" name="concede2" value="WPU_ODD" id="WPU_ODD"   />
                    </td>
                    <td class="odds" >
                        <span class="dd">'.$odds["h13"].'</span>&nbsp;
                        <input type="radio" name="concede2" value="WPU_EVEN" id="WPU_EVEN"  />
                    </td>
                    <td class="odds" >
                        <span class="dd">'.$odds["h14"].'</span>&nbsp;
                        <input type="radio" name="concede2" value="WPU_OVER" id="WPU_OVER"   />
                    </td>
                    <td class="odds" >
                        <span class="dd">'.$odds["h15"].'</span>&nbsp;
                        <input type="radio" name="concede2" value="WPU_UNDER" id="WPU_UNDER"  />
                    </td>
                    <td class="odds" >
                        <span class="dd">'.$odds["h16"].'</span>&nbsp;
                        <input type="radio" name="concede2" value="WPU_PRIME" id="WPU_PRIME"   />
                    </td>
                    <td class="odds" >
                        <span class="dd">'.$odds["h17"].'</span>&nbsp;
                        <input type="radio" name="concede2" value="WPU_COMPO" id="WPU_COMPO"  />
                    </td>
                </tr>
            </table>
        </div>
        <div id="SendB3"><input type="button" name="Cancel" value="取消" class="cancel_cen" />&nbsp;&nbsp;<input type="button" name="order" value="确定" class="order" /></div>
    </form>

</div>
<input type="hidden" id="sRtype" name="sRtype" value="WP" />
<input type="hidden" id="sGtype" name="sGtype" value="'.$gType.'" />
<input type="hidden" name="iTime" id="iTime" value="1393482748" />
</div>
</div>
</div>
</div>
