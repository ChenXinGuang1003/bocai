...
<div id="content_inner">
    ...
    <div>
        ...
        <div id="wager_groups" class="'.$gType.'">
            ...
            <a href="/member/b3/b3.php?gtype='.$gType.'&amp;rtype=GST" class="NowPlay" title="组选三">组选三</a>
...
<input type="hidden" id="sRtype" name="sRtype" value="GST" />
<input type="hidden" id="sGtype" name="sGtype" value="'.$gType.'" />
<input type="hidden" name="iTime" id="iTime" value="1393482702" />
</div>
</div>
</div>
</div>
