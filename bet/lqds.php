	...
	<card title="篮球单式">
		<p>
			...
			<?php
				...
				do{
			?>
			<a href="bet_lqds.php?matchname=<?=urlencode($row['match_name'])?>" title="<?=$row['match_name']?>"><?=$row['match_name']?></a>(<?=$row['s']?>)
			<br/>
			<?php
			...
			?>
			<br/>
			<a href="lqds.php?<?=rand()?>" title="刷新">刷新</a> <a href="../main.php" title="返回菜单">返回菜单</a>
		</p>
	</card>
</wml>