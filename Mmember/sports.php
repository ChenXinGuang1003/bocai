...
<html>
	<head>
		...
		<style>
			...
			body{ margin:0; height:100%; width:100%; font-size: 0.14rem; }
	...
	<script>
		(function(){
			var iFrame = $('<iframe id="iframes" src="/cl/index.php?module=MACenterView&method=ballRecord" width="100%" height="100%" scrolling="no" frameborder="0"></iframe>');
