 ...
 */
include_once '/newmg2/http.class.php';
class BBIN_TZH
{
    private $url    = "http://47.88.8.241:741/MG";
    private $comId   = "yl66y";
    private $comKey  = "917d60e281a09da0";
    public $gamePlatform = "MG";
    public $debug = 0;



    public function BBIN_TZH($comId,$comKey,$gamePlatform="MG")
    {
        $this->comId    = $comId;
        $this->comKey   = $comKey;  
