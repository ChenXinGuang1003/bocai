...
<div id="header">
      ...
      <div id="header-logo">
            <object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://fpdownload.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,0,0" width="425" height="130">  
            ...
            <embed src="logo.swf" autoplay="true" flashvars="prizeResult=3" allowscriptaccess="always" wmode="transparent" menu="false" quality="high" width="425" height="130" type="application/x-shockwave-flash" pluginspage="http://get.adobe.com/cn/flashplayer/" name="FlashZhuan"> 
         </object>
      </div>  
      <div id="headtop">
	      <!--  <div id="hdselect">
                     ...
                     <div id="hdselect" style="width:497px;"><a onclick="click_url('/member/lottery/Cqssc1.php')" style="cursor:pointer;">手机专区</a>&nbsp;|&nbsp;<a href="javascript:click_url('/app/member/help/dlhz4.php');">存款帮助</a>&nbsp;|&nbsp;<a href="javascript:click_url('/app/member/help/dlhz5.php');">取款帮助</a>&nbsp;|&nbsp;<a href="javascript:click_url('/app/member/help/dlhz.php');">代理合作</a>&nbsp;|&nbsp;<a href="javascript:click_url('/app/member/help/dlhz6.php');">常见问题</a>
                     </div>
           ...
           <form name="LoginForm" id="LoginForm" onsubmit="return false;">         
                <div id="loginbox1">        
                      <div class="login_ip" style="position:absolute;top:10px;left:25px;">
                                <input style="text-indent:10px;" type="text" onfocus="if(this.value=='账号'){this.value='';}" onblur="if(this.value==''){this.value='账号';}" value="账号" class="login_input01" maxlength="20" tabindex="1" id="username" name="username">
                       </div>
                       ...
                       <div class="login_ip" style="position:absolute;top:43px;left:20px;">
                                <input type="text" value="验证码" onfocus="if(this.value==this.defaultValue) {this.value=''}" onblur="if(this.value=='') {this.value=this.defaultValue}" class="rmNum  login_input02" id="rmNum" maxlength="4" name="rmNum" style="width:95px;">
                                <img width="50" height="23" border="0" align="absmiddle" src="/yzm.php" onclick="getKey();" id="vPic">
                       </div>              
                </div>
                <div id="loginbox2">
                     <input style="position:absolute;top:40px;left:177px;" type="button" id="ibtnLogin" name="formsub" onclick="aLeftForm1Sub();">
                     <a style="position:absolute;top:45px;left:258px;" class="forpwd" href="javascript:alert('请联系客服咨询！');"></a>
                </div> 
                </form>
        </div>
...
<div style="    width: 480px;
	...
	<div id="top_login">
	  <ul>
	  <li>帐号:<font size="2"><b><?= $username; ?></b></font></li>
        ...
        <div id="menu">
            ...
            <ul>
                  <li class="normal"><a class="pngfix"  onclick="click_url('/cl/main.php')" href="javascript:void(0);">首页</a></li>
				   <li class="normal"><a class="pngfix " target="_self" onclick="click_url('/app/member/sport.php',1)" href="javascript:void(0);">皇冠体育</a></li>

                  <li class="normal"><a class="pngfix " onclick="click_url('/member/zhenren/mylive.php')" href="javascript:void(0);">真人视讯</a></li>
                 				   <li class="normal">
<a class="pngfix " onclick="click_url('/member/lottery/dzyy.php')" href="javascript:void(0);">

电子游艺</a>
</li>
                  <li class="normal"><a class="pngfix " onclick="click_url('/member/lottery/Cqssc.php?1=1')" href="javascript:void(0);">彩票游戏</a></li>

                  <li class="normal"><a class="pngfix " onclick="click_url('/member/lt/',1)" href="javascript:void(0);">六合彩</a></li>
                  <li class="normal"><a target="_self" onclick="click_url('/cl/offer.php')" href="javascript:void(0);" id="textGlitter">优惠活动</a></li>
                  <li class="normal"><!-- <a class="pngfix" target="_blank" href="/member/mobile/mobile.html"> --><a class="pngfix " onclick="click_url('/member/lottery/Cqssc1.php')" href="javascript:void(0);">手机投注</a></li>
                  <li class="normal"><a onclick="window.open('http://t.ibangkf.com/i/chat-hg66g.html?l=hg66g&amp;page=file%3A///C%3A/Documents%2520and%2520Settings/Administrator/%25E6%25A1%258C%25E9%259D%25A2/hs.html&amp;t=1460449591311', '皇冠国际娱乐城', 'height=400, width=700, top=200, left=200, toolbar=no, menubar=no, scrollbars=no, resizable=no, location=no, status=no');" href="javascript:;" style="width: 122px; height: 356px;">在线客服</a></li>
