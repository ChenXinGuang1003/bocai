...
#headerBox .logo{ display:block; position:absolute; left:calc(1.5rem - 0.46rem); top:calc(0.18rem - 0.16rem); height:0.3rem; }
    ...
    background:url('das.png') !important;
    border: none;
    text-align:center;
    color: #fff;}
...
<table id="centers" width="100%" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <td width="23%" class="pad"><span class="STYLE2">6217 0072  0003 7013 649</span></td>    
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td width="23%" class="pad"><span class="STYLE2">yl66aa@139.com</span></td>
        ...
        <tr>
            <td width="7%" class="col">开户名：</td>
            <td width="11%"><span class="STYLE2">永利国际</span></td>
        </tr>
        <tr>
