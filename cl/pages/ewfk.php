...
<tr>
    ...
    <td align="left" valign="middle"><table width="115">
            <tr><td class="STYLE5" style="padding-left:16px;"><input name="vlcodes" type="text" id="vlcodes" size="5" maxlength="4" onfocus="next_checkNum_img()" onkeyup="clearNoNum(this);" style="border:1px solid #CCCCCC;height:18px;line-height:20px; width:61px;margin-left:20px;"/></td><td>
